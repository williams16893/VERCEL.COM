...
var Sift = Sift || function() {
    ...
    for (var S = (new Date).getTime(), x = document, l = navigator, r = screen, n = window, q = n.encodeURIComponent, P = n.decodeURIComponent, F = "vercel.com/_stream/external/hexagon-analytics.com", w, T = 0, H = "__ssid", z, B, A, G, C, Q = 4, O = 106, R = 100, I = function() {
